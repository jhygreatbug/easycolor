...
describe('Input', function() {
	describe('Parse keyword', function() {
	})
	...
	describe('Parse text', function() {
		...
		it('Keyword', function() {
			...
			Color('blanchedalmond').toString().should.equal('blanchedalmond');
			...
			Color('darkgrey').toString().should.equal('darkgrey');
			...
			Color('darkslategrey').toString().should.equal('darkslategrey');
			...
			Color('dimgrey').toString().should.equal('dimgrey');
			...
			Color('grey').toString().should.equal('grey');
			...
			Color('lightgrey').toString().should.equal('lightgrey');
			...
			Color('lightslategrey').toString().should.equal('lightslategrey');
			...
			Color('slategrey').toString().should.equal('slategrey');
